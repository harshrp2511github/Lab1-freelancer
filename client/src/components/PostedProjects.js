...
class PostedProject extends Component{
    ...
    getMyProjects = (userdata) =>{
        API.getMyProjectList(userdata)
            .then((result) => {
                //console.log(JSON.stringify(status));
                debugger;
            ...
            return (
                ...
                return (
                    <div className="container " style={{
                        ...
                        <h5 style={{paddingLeft: '800px', paddingTop: '30px'}}>Price(USD): ${project.projectmin} -
                            ${project.projectmax}</h5>
                        <h3 style={{ marginTop: '20px', textDecoration: 'underline',marginLeft: '800px', fontWeight: 'bold'}}>SOLD TO: {project.winnername} </h3>
    ...
    render(){
        ...
        return(
            ...
            overflowY: 'scroll'}}>
                ...
                <div className="container" style={{color: 'white', textAlign: 'left',paddingTop: '10px',marginTop: '20px', height: '50px',paddingLeft: '20px', backgroundColor: '#3a3b3d'}} >
                    <h4>MY POSTED PROJECTS</h4>
                </div>
                {this.renderProjects()}
                <Link to="/inapp" class="btn" style={{ marginBottom: '100px',position: 'absolute' ,backgroundColor: '#fc951e', color: 'white', textAlign: 'center', marginTop: '50px', marginLeft: '-50px'}}>BACK TO HOME</Link>
            </div>
        );
    }
}
