        ...
        API.doCheckLogin()
            .then((status) => {
                ...
                if (status.status == 'true') {
                    ...
                    this.props.redirectURL('/updateskills');
                }
                else{
            ...
            <div style={{ backgroundImage: "url(" + coverimage + ")", position: 'absolute', width: '1532px', height: '356px'}}>
                ...
                <div className="container" style={{ width: '1000px', height: '450px', position: 'absolute', backgroundColor: 'white',  marginLeft: '270px', marginTop: '150px', marginBottom: '100px',color: 'black'}}>
                    ...
                    <div style={{ position: 'absolute', marginTop: '20px', marginLeft: '270px', width: '450px', height: '400px', backgroundColor: 'white' }}>
                        ...
                        <div style={{ textAlign: 'left', marginTop: '40px'}}><input
                            ...
                            required
                        /></div>
                        <div style={{ color: 'red', fontSize: '15px', paddingTop: '0px', textAlign: 'left', paddingLeft: '20px', position: 'absolute', marginTop: '250px'}}>
                    ...
                    <div style={{ position: 'absolute', marginTop: '50px', marginLeft: '650px', width: '50px', height: '400px', backgroundColor: 'white' }}>
                        <div style={{ textAlign: 'left'}}><span className="glyphicon glyphicon-pencil"></span></div>
                        <div style={{ textAlign: 'left', marginTop: '45px'}}><span className="glyphicon glyphicon-ok"  onClick={() => this.handleUpdate(this.state)} style={{ color: 'green'}}></span><span className="glyphicon glyphicon-remove" onClick={() => this.handleCancel()} style={{paddingLeft: '15px', color: 'red'}}></span></div>
                    ...
                    <div style={{ position: 'absolute', marginTop: '0px', marginLeft: '950px', width: '50px', height: '450px', backgroundColor: '#efefef',  textAlign:'center'}}>
                        ...
                        <div style={{ marginTop: '35px'}}><span className="glyphicon glyphicon-pencil"></span></div>
                    </div>
