...
export const updateBidCount = (payload) =>
    fetch(`${api}/users/updatebidcount`, {
        method: 'POST',
        headers: {
            ...headers,
            'Content-Type': 'application/json'
...
export const updateAvg = (payload) =>
    fetch(`${api}/users/updateavg`, {
        method: 'POST',
        headers: {
            ...headers,
            'Content-Type': 'application/json'
